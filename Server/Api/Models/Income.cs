...
namespace TaxumoChatBot.Api.Models
{
    ...
    public partial class Income
    {
        ...
        /// Initializes a new instance of the Income class.
        /// </summary>
        public Income(int company, int? id = default(int?), double? amount = default(double?), string description = default(string), string controlNo = default(string), System.DateTime? transactionDate = default(System.DateTime?), System.DateTime? dateModified = default(System.DateTime?), string business = default(string), string receipt = default(string), int? category = default(int?))
        {
            Id = id;
            Company = company;
            Amount = amount;
