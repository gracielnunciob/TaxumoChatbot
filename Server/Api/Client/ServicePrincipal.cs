...
namespace TaxumoChatBot.Api
{
	public static class ServicePrincipal
	{
		...
		static string authority = Program.Configuration["ida:Authority"];
		...
		static string clientId = Program.Configuration["ida:ClientId"];

		// The key that was created for the calling AAD app. For example: oCgdj3EYLfnR0p6iR3UvHFAfkn+zQB+0VqZT/6=
		static string clientSecret = Program.Configuration["ida:ClientSecret"];
		...
		static string resource = Program.Configuration["ida:Resource"];
